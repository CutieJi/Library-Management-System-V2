    ...
    <div class="row h-100">
            ...
            <div id="auth-left">
                ...
                <div class="text-center mt-5 text-lg fs-4">
                    <p class="text-gray-600">
                        ...
                        <a href="<?= base_url("auth/signup"); ?>" class="font-bold text-success">Sign up.</a>
                    </p>
                    <!-- <p>
        ...
        <div class="col-lg-7 d-none d-lg-block  ">
            <div id="auth-right" class="d-flex align-items-center justify-content-center h-100">
                <img src="<?= base_url(); ?>assets/img/vector/OpenDoodles/png/ucc_campus.png" alt="Reading Doodle" class="w-75">
            </div>
        </div>
    </div>
</div>