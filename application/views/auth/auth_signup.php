    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                ...
                <form method="POST" action="<?= base_url('auth/signup'); ?>">
                    ...
                    <button type="submit" class="btn btn-success btn-block btn-lg shadow-lg mt-5">Sign Up</button>

                </form>
                <div class="text-center mt-5 text-lg fs-4">
                    <p class='text-gray-600'>Already have an account? <a href="<?= base_url(); ?>" class="font-bold text-success">Log In.</a></p>
                </div>
            </div>
        ...
        <div class="col-lg-7 d-none d-lg-block">
            <div id="auth-right" class="d-flex align-items-center justify-content-center h-100">
                <img src="<?= base_url(); ?>assets/img/vector/OpenDoodles/png/ucc_campus.png    " alt="Sit Reading Doodle" class="w-75">
            </div>
        </div>
    </div>
