            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8 p-3">
                    ...
                    <div class="float-end mt-3">
                        <!-- <button class="btn btn-success"><i class="fas fa-fw fa-cart-arrow-down me-1"></i> Add to Cart</button> -->
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modallAddBorrowBook">Borrow Book</button>
                    </div>
                </div>
