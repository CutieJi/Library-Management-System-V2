...
<section class="section">
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modallAddNewRole">Add New Role</a>
        </div>
        <div class="card-body">
...
<!-- Modal Add New Role -->
<div class="modal fade" id="modallAddNewRole" tabindex="-1" role="dialog" aria-labelledby="modallAddUserDataTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modallAddUserDataTitle">Add New Role</h5>
